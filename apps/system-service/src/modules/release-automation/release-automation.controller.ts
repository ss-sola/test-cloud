  ...
  private toPlan(body: CreateReleaseAutomationJobDto, defaultMode: ReleaseMode): ReleasePlanInput {
    return {
      ...
      pageConfig: {
        ...
        githubBaseUrl: body.githubBaseUrl,
        githubAllowedHosts: body.githubAllowedHosts,
        ...
        modifyLogMaxLines: body.modifyLogMaxLines,
        jenkinsToken: body.jenkinsToken ?? '',
        jenkinsBaseUrl: body.jenkinsBaseUrl ?? '',
        jenkinsTagMarker: body.jenkinsTagMarker ?? '',
        jenkinsTimeoutMs: body.jenkinsTimeoutMs,
        jenkinsMaxRetries: body.jenkinsMaxRetries,
        jenkinsPollIntervalMs: body.jenkinsPollIntervalMs,
        jenkinsQueueTimeoutMs: body.jenkinsQueueTimeoutMs,
        jenkinsBuildTimeoutMs: body.jenkinsBuildTimeoutMs,
        jenkinsMaxResponseBytes: body.jenkinsMaxResponseBytes,
        jenkinsPlatform: body.jenkinsPlatform,
