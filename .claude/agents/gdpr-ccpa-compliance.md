...
description: Use when the user needs to understand GDPR or CCPA compliance, review data practices, or assess privacy requirements. Triggers on: "GDPR/CCPA 隐私合规专家 — 隐私法规遵从性检查（低契合度）。"
